...
const Login = () => {
  ...
  function handleFormClick(){
    ...
    seterrMsg(validateForm(email.current.value, password.current.value))
  }
      ...
      <div className='relative w-full h-screen overflow-hidden'>
        ...
        left-1/3 p-4 gap-4 rounded-lg w-1/3 opacity-85 text-wrap m-5'>
          ...
          <form onClick={(e)=>e.preventDefault()} className='flex flex-col gap-4 p-4'>
            ...
            {isSignIn ? null : <input type='text' placeholder='Full Name' className='border border-white p-2 rounded-lg bg-gray-950' /> }
